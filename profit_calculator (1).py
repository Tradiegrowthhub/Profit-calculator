...
st.markdown("#### What's your annual revenue? (just your best guess is fine)")
...
st.markdown("#### Great! Now, what's your gross profit margin as a percentage?")
...
st.markdown("#### And what's your net profit margin?")
